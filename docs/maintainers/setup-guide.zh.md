...
**语言:** <a href="setup-guide.md">English</a> | 中文
...
1. **阅读** [CONTRIBUTING.md](https://github.com/tinkle-community/nofx/blob/main/CONTRIBUTING.md)
2. **查看** [路线图](../roadmap/index.zh.md)了解优先级
3. **开启 issue** 或找到现有的
4. **使用模板创建 PR**
5. **处理审核反馈**
6. **庆祝** 当合并时！🎉
...
4. **遵循：** [PR 审核指南](pr-review-guide.zh.md)
5. **遵循：** [项目管理指南](project-management.zh.md)
