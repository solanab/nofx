...
**Language:** English | <a href="setup-guide.zh.md">中文</a>
...
1. **Read** [CONTRIBUTING.md](https://github.com/tinkle-community/nofx/blob/main/CONTRIBUTING.md)
2. **Check** [Roadmap](../roadmap/index.md) for priorities
...
4. **Follow:** [PR Review Guide](pr-review-guide.md)
5. **Follow:** [Project Management Guide](project-management.md)
