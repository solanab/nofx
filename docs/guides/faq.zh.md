...
快速解答常见问题。详细故障排查请参考[故障排查指南](troubleshooting.zh.md)。
...
- 余额或保证金不足
- 达到持仓上限（默认最多 3 个仓位）
- 详细诊断请查看[故障排查指南](troubleshooting.zh.md#ai-总是说等待持有)
...
参见 [Issue #202](https://github.com/tinkle-community/nofx/issues/202) 和[故障排查指南](troubleshooting.zh.md#只开空单不开多单-issue-202)。
...
如果不是，查看[故障排查指南](troubleshooting.zh.md#前端无法连接后端)。
...
### 在哪里可以找到详细的故障排查？
查看全面的[故障排查指南](troubleshooting.zh.md)，包含：
- 分步诊断方法
- 日志收集方法
- 常见错误解决方案
- 紧急重置步骤
...
### 如何报告 Bug？
1. 先查看[故障排查指南](troubleshooting.zh.md)
2. 搜索[现有 Issues](https://github.com/tinkle-community/nofx/issues)
3. 如果没找到，[提交新 Issue](https://github.com/tinkle-community/nofx/issues/new/choose)
...
- 文档改进
- 翻译
- 查看[贡献指南](https://github.com/tinkle-community/nofx/blob/main/CONTRIBUTING.md)
