...
3. If not found, [open a new issue](https://github.com/tinkle-community/nofx/issues/new/choose)
...
- Translations
- See [Contributing Guide](https://github.com/tinkle-community/nofx/blob/main/CONTRIBUTING.md)
