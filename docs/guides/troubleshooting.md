...
#### ❌ Only Opening Short Positions (Issue #202) {#only-opening-short-positions-issue-202}
...
#### ❌ AI Always Says "Wait" / "Hold" {#ai-always-says-wait-hold}
...
## 📊 How to Capture Logs {#how-to-capture-logs}
...
2. **Submit Bug Report:**
   - [Open a new issue](https://github.com/tinkle-community/nofx/issues/new/choose)
...
- **[Architecture Docs](../architecture/index.md)** - How the system works
