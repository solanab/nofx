...
#### ❌ 只开空单，不开多单 (Issue #202) {#只开空单不开多单-issue-202}
...
2. **提交 Bug 报告:**
   - [提交新 Issue](https://github.com/tinkle-community/nofx/issues/new/choose)
   - 包含所有日志和截图
   - 描述您已尝试的方法
...
- **[FAQ](faq.zh.md)** - 常见问题
- **[快速开始](../getting-started/index.zh.md)** - 安装指南
- **[架构文档](../architecture/index.zh.md)** - 系统工作原理
