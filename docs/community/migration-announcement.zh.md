...
✅ **清晰的贡献指南** 与我们的[路线图](../roadmap/index.zh.md)对齐
...
**📖 完整指南：** [如何迁移你的 PR](how-to-migrate-pr.zh.md)
...
- ✅ 这是一个学习期 - 我们在这里帮助！
- ✅ 熟悉新的[贡献指南](https://github.com/tinkle-community/nofx/blob/main/CONTRIBUTING.md)

#### 第 4 周+（完全启动）：
- ✅ 所有自动化检查必须通过才能合并
- ✅ PR 必须遵循 [Conventional Commits](https://www.conventionalcommits.org/) 格式
- ✅ 必须填写 PR 模板
- ✅ 必须与[路线图](../roadmap/index.zh.md)优先级对齐
...
### 必读
- [贡献指南](https://github.com/tinkle-community/nofx/blob/main/CONTRIBUTING.md) - 完整指南
- [路线图](../roadmap/index.zh.md) - 当前优先级
